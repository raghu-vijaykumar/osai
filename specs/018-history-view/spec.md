...
**Feature Branch**: `018-history-view`

**Created**: 2026-07-11

**Status**: Draft

**Input**: A chronological view of your past, organized by sessions (not individual events). Browse what you did on any day, filter by source, topic, or entity. Sessions are the primary visual unit, with events expandable within them. Formerly Timeline View.
...
- Source code lives at `ui/history/` in the monorepo (renamed from `018-timeline-view`)
