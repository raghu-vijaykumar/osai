# Feature Specification: Explore

**Feature Branch**: `020-explore-view`

**Created**: 2026-07-11

**Status**: Draft

**Input**: A discovery surface for your memory. Shows connections you might not have noticed — related topics, entity maps, and suggested paths between ideas. Includes an interactive graph visualization as one mode among several (list, timeline, map). Formerly Graph View.

## User Scenarios & Testing

### User Story 1 - Interactive Graph Visualization (Priority: P1)

The Explore screen includes a graph view that renders the knowledge graph as an interactive force-directed layout. Nodes represent entities, events, and topics. Edges represent relationships. Users can pan, zoom, click, and drag nodes. Node and edge colors/types are visually distinct.
...
1. **Given** a visible "TypeScript" node, **When** clicked, **Then** a popover shows: type (technology), mention count, top 3 related events, and "Expand neighbors" and "View in History" buttons
...
- **FR-005**: Clicking a node MUST show a detail popover with: name, type, mention count, top related events, entity metrics, and action buttons (Expand, View in History, View in Topics)
...
- Source code lives at `ui/explore/` in the monorepo (renamed from `020-graph-view`)
